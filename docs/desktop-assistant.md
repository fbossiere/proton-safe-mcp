...
Download [the Ubuntu 24.04 x86_64 installer](https://github.com/fbossiere/proton-safe-mcp/releases/download/v2.2.0/proton-safe-assistant_2.2.0_amd64.deb)
from the [v2.2.0 release](https://github.com/fbossiere/proton-safe-mcp/releases/tag/v2.2.0).
...
and run `sha256sum -c proton-safe-assistant_2.2.0_amd64.deb.sha256`.
